...
$query=mysqli_query($connect,"update tblsubcategory set CategoryId='$categoryid',Subcategory='$subcatname',SubCatDescription='$subcatdescription' where SubCategoryId='$subcatid'");
if($query)
{
...
<html lang="en">
    <head>
        ...
        <title>SMDK | Edit Sub Category</title>
