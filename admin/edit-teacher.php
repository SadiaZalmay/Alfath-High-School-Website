...
// else{
    if(isset($_POST['submit'])){  
        ...
        $fname = $_POST['fname'];
        $des = $_POST['education'];
        $se = $_POST['description'];
        $pic = "images/". $_FILES['image']['name'];
        move_uploaded_file($_FILES['image']['tmp_name'], "images/" . $_FILES['image']['name']);
        $query=mysqli_query($connect,"Update  teacher set t_name=' $tname',fname='$fname',education='$des',description=' $se',img='$pic' where id='$catid'");
        if($query)
        {
...
<html lang="en">
    <head>
        ...
        <title>Newsportal | Add teacher</title>
                        				...
                        				<div class="col-md-6">
                        					<form class="form-horizontal" name="course" method="post" enctype = "multipart/form-data">
	                                            <div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control" value="" name="tname" required>
	                                                </div>
	                                            </div>
                                                ...
                                                <div class="form-group">
	                                                ...
	                                                <div class="col-md-5">
                                                       ...
                                                       <option>besholai</option>
                                                       <option>masrtar</option>
                                                       </select>
	                                                </div>
	                                            </div>
