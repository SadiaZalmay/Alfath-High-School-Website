...
// else{
 ...
 {
 $cate=$_POST['AdminUserName'];
$descr=$_POST['AdminPassword'];
$ca=$_POST['AdminEmailId'];
$status=1;

$query=mysqli_query($connect,"insert into tbladmin(AdminUserName,AdminPassword,AdminEmailId,Is_Active) values(' $cate','$descr','$ca','$status')");
if($query)
{
