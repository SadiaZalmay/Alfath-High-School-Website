...
{
	$id=intval($_GET['scid']);
	$query=mysqli_query($connect,"update  tblsubcategory set Is_Active='0' where SubCategoryId='$id'");
...
if($_GET['resid'])
{
	...
	$query=mysqli_query($connect,"update  tblsubcategory set Is_Active='1' where SubCategoryId='$id'");
...
{
	$id=intval($_GET['scid']);
	$query=mysqli_query($connect,"delete from   tblsubcategory  where SubCategoryId='$id'");
...
<html lang="en">
    <head>
        ...
        <title> SMDK News | Manage SubCategories</title>
...
<button id="addToTable" class="btn btn-success waves-effect waves-light">Add <i class="mdi mdi-plus-circle-outline" ></i></button>
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($connect,"Select tblcategory.CategoryName as catname,tblsubcategory.Subcategory as subcatname,tblsubcategory.SubCatDescription as SubCatDescription,tblsubcategory.PostingDate as subcatpostingdate,tblsubcategory.UpdationDate as subcatupdationdate,tblsubcategory.SubCategoryId as subcatid from tblsubcategory join tblcategory on tblsubcategory.CategoryId=tblcategory.id where tblsubcategory.Is_Active=1");
$cnt=1;
