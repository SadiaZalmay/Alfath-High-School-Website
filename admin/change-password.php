...
$sql=mysqli_query($connect,"SELECT AdminPassword FROM  tbladmin where AdminUserName='$adminid' || AdminEmailId='$adminid'");
...
if (password_verify($password, $dbpassword)) {
 ...
 $con=mysqli_query($connect,"update tbladmin set AdminPassword='$newhashedpass', updationDate='$currentTime' where AdminUserName='$adminid'");
