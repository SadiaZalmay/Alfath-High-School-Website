...
$query=mysqli_query($connect,"update tblposts set Is_Active=1 where id='$postid'");
if($query)
{
...
if($_GET['presid'])
{
    ...
    $query=mysqli_query($connect,"delete from  tblposts  where id='$id'");
...
<?php
$query=mysqli_query($connect,"select tblposts.id as postid,tblposts.PostTitle as title,tblcategory.CategoryName as category,tblsubcategory.Subcategory as subcategory from tblposts left join tblcategory on tblcategory.id=tblposts.CategoryId left join tblsubcategory on tblsubcategory.SubCategoryId=tblposts.SubCategoryId where tblposts.Is_Active=0");
