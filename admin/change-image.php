...
$query=mysqli_query($connect,"update tblposts set PostImage='$imgnewfile' where id='$postid'");
if($query)
{
...
<?php
$postid=intval($_GET['pid']);
$query=mysqli_query($connect,"select PostImage,PostTitle from tblposts where id='$postid' and Is_Active=1 ");
