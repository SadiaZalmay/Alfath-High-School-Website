...
$query=mysqli_query($connect,"Update  tblcategory set CategoryName='$category',Description='$description' where id='$catid'");
if($query)
{
...
<?php 
$catid=intval($_GET['cid']);
$query=mysqli_query($connect,"Select id,CategoryName,Description,PostingDate,UpdationDate from  tblcategory where Is_Active=1 and id='$catid'");
$cnt=1;
