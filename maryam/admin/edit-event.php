...
// else{
    if(isset($_POST['post'])){  
        ...
        $query=mysqli_query($connect,"Update  event set eventname='$name', evdescription='$descrip',createevent='$create',UpdationDateev='$Updation' where id='$catid'");
        if($query)
        {
...
<?php 
$catid=intval($_GET['cid']);
$query=mysqli_query($connect,"Select id,eventname,evdescription,createevent,UpdationDateev from event");
$cnt=1;
                                        ...
                                        <div class="col-md-12">
                                            <form action  = "#" method = "POST" class = "form-horzintal well col-md-6" enctype = "multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">event</label>
                                                    <div class="col-md-10">
                                                        <input type = "date" name = "createevent" class = "form-control" required><br>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">event</label>
                                                    <div class="col-md-10">
                                                        <input type = "date" name = "UpdationDateev" class = "form-control" required><br>
                                                    </div>
                                                </div>
