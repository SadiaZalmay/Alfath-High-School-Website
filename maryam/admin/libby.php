        ...
        $des = $_POST['comment'];
         $pic = "images/". $_FILES['image']['name'];
          move_uploaded_file($_FILES['image']['tmp_name'], "images/" . $_FILES['image']['name']);
            if(!empty($des) && !empty($pic)){
                $sql = "INSERT INTO lib(id,description,l_img) VALUES('','$des','$pic')";
                                        ...
                                        <div class="col-md-12">
                                            <form action  = "#" method = "POST" class = "form-horzintal well col-md-6" enctype = "multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea cols = "65" rows = "5" class = "form-control" name = "comment" required></textarea>
                                                    </div>
                                                </div><br><br>
                                                 <div class="form-group">
