...
// else{
    if(isset($_POST['submit'])){  
        ...
        $query=mysqli_query($connect,"Update  student_info set g_student=' $tname', c_student=' $student' where id='$catid'");
        if($query)
        {
...
<?php 
$catid=intval($_GET['cid']);
$query=mysqli_query($connect,"Select id,g_student,c_student from student_info");
$cnt=1;
