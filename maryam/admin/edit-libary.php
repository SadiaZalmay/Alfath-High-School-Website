...
// else{
    if(isset($_POST['submit'])){  
        ...
        $query=mysqli_query($connect,"Update  lib set description=' $tname' where id='$catid'");
        if($query)
        {
...
<?php 
$catid=intval($_GET['cid']);
$query=mysqli_query($connect,"Select id,description,l_img from lib");
$cnt=1;
                                        ...
                                        <div class="col-md-12">
                                            <form action  = "#" method = "POST" class = "form-horzintal well col-md-6" enctype = "multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea cols = "65" rows = "5" class = "form-control" name = "description" required></textarea>
                                                    </div>
                                                </div><br><br>
                                                 <!-- <div class="form-group">
                                                <label class="col-md-2 control-label">Add Image</label>
                                                    <div class="col-md-10"><br>
                                                       <input type = "file" name = "l_img" class = "btn btn-primary btn-file "  required>
                                                    </div></div> -->
