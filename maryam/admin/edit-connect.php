...
// else{
    if(isset($_POST['post'])){  
        ...
        $name= $_POST['name'];
        $descrip = $_POST['massage'];
        $create = $_POST['emile'];
        
        $query=mysqli_query($connect,"Update  connect set name='$name',massage='$descrip',emile='$create' where id='$catid'");
        if($query)
        {
...
<?php 
$catid=intval($_GET['cid']);
$query=mysqli_query($connect,"Select id,name,massage,emile from connect");
$cnt=1;
                                        ...
                                        <div class="col-md-12">
                                            <form action  = "#" method = "POST" class = "form-horzintal well col-md-6" enctype = "multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea cols = "65" rows = "5" class = "form-control" name = "massage" required></textarea><br>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">event</label>
                                                    <div class="col-md-10">
                                                        <input type = "email" name = "emile" class = "form-control" required><br>
                                                    </div>
                                                </div>
